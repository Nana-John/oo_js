...
class Vehicle {
  ...
  // Testando os objetos
  console.log(car1.move()); // Sedan (a car) is cruising at 120 km/h with 4 doors.
  console.log(car2.move()); // SUV (a car) is cruising at 150 km/h with 5 doors.
  console.log(bike1.move()); // Mountain Bike (a mountain bike) is zooming at 30 km/h.
